...
export const flapCardList=[
    {
        ...
        _g:102,
        b:159,
        imgLeft:`url(${process.env.VUE_APP_RES_URL}/images/gift-left.png)`,
        imgRight:`url(${process.env.VUE_APP_RES_URL}/images/gift-right.png)`,
    ...
    },
    {
        ...
        _g:171,
        b:255,
        imgLeft:`url(${process.env.VUE_APP_RES_URL}/images/compass-left.png)`,
        imgRight:`url(${process.env.VUE_APP_RES_URL}/images/compass-right.png)`,
        backgroundSize:'50% 50%',
        zIndex:99,
        rotateDegree:0
    },
    {
        ...
        _g:198,
        b:102,
        imgLeft:`url(${process.env.VUE_APP_RES_URL}/images/star-left.png)`,
        imgRight:`url(${process.env.VUE_APP_RES_URL}/images/star-right.png)`,
        backgroundSize:'50% 50%',
        zIndex:98,
        rotateDegree:0
    },
    {
        ...
        _g:102,
        b:159,
        imgLeft:`url(${process.env.VUE_APP_RES_URL}/images/heart-left.png)`,
        imgRight:`url(${process.env.VUE_APP_RES_URL}/images/heart-right.png)`,
        backgroundSize:'50% 50%',
        zIndex:97,
        rotateDegree:0
    },
    {
        ...
        _g:201,
        b:2,
        imgLeft:`url(${process.env.VUE_APP_RES_URL}/images/crown-left.png)`,
        imgRight:`url(${process.env.VUE_APP_RES_URL}/images/crown-right.png)`,
        backgroundSize:'50% 50%',
        zIndex:96,
        rotateDegree:0
    }
...
export function addToShelf(book) {
    let shelfList = getLocalStorage(BOOK_SHELF_KEY)
