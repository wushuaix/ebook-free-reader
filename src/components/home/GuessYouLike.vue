    ...
    <div class="guess-you-like-list">
      <div class="guess-you-like-item" v-for="(item, index) in showData" :key="index" @click="showBookDetail(item)">
        <div class="img-wrapper">
          <img class="img" :src="showData?item.cover:''" :key="item.cover">
        </div>
        <div class="content-wrapper">
          <div class="title title-big" ref="title">{{showData?item.title:''}}</div>
          <div class="author sub-title" ref="author">{{showData?item.author:''}}</div>
