      ...
      <div class="featured-item-wrapper">
        <div class="featured-item" v-for="(item, index) in data" :key="index" @click="showBookDetail(item)">
          <div class="img-wrapper">
            <img class="img" :src="data?item.cover:''">
          </div>
          <div class="content-wrapper">
            <div class="title title-small" ref="title">{{data?item.title:''}}</div>
            <div class="author sub-title-tiny" ref="author">{{data?item.author:''}}</div>
            <div class="category third-title-tiny" ref="category">{{categoryText(data?item.category:'')}}</div>
          </div>
        </div>
      </div>
    </div>
