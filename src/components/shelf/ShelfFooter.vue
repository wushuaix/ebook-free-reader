...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            downloadBook(book){
                ...
                return new Promise((resolve, reject) => {
                    download(book,book=>{
                        ...
                        const progress=Math.floor(progressEvent
            ...
            removeBook(book){
                return new Promise((resolve, reject) => {
                    removeLocalStorage(`$t{'book.categoryText'}/$t{'book.fileName'}-info`)
            ...
            showDownload(){
                this.popupMenu=this.popup({
                    ...
                    btn:[
                        {
                            text:this.isDownload?this.$t('shelf.delete'):
                                this.$t('shelf.open'),
                            click:()=>{
                                this.setDownload()
                            }
            ...
            showRemove(){
                ...
                if(this.shelfSelected.length===1){
                    title=this.$t('shelf.removeBookTitle').replace('$1',
